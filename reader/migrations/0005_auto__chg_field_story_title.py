...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reader_story', 'title', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Story.title'
        db.alter_column(u'reader_story', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))
