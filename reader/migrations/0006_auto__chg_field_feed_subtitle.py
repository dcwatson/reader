...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reader_feed', 'subtitle', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Feed.subtitle'
        db.alter_column(u'reader_feed', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=200))
