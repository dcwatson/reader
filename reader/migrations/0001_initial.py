    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(default=django.utils.timezone.now)),
                ('user', models.ForeignKey(to='users.User', related_name='login_tokens', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(to='users.User', related_name='smart_feeds', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feed', models.ForeignKey(to='reader.Feed', related_name='stories', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feed', models.ForeignKey(to='reader.Feed', related_name='subscriptions', on_delete=models.CASCADE)),
                ('user', models.ForeignKey(to='users.User', related_name='subscriptions', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='story',
            field=models.ForeignKey(to='reader.Story', related_name='read_stories', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='readstory',
            name='user',
            field=models.ForeignKey(to='users.User', related_name='read_stories', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='readstory',
