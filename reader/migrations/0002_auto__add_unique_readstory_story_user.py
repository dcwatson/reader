...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ReadStory', fields ['story', 'user']
        db.create_unique(u'reader_readstory', ['story_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ReadStory', fields ['story', 'user']
        db.delete_unique(u'reader_readstory', ['story_id', 'user_id'])
